...
public class ReservationDB {
    ...
    public ReservationDB(int n_s, ArrayList<String> s_n, double c, Customer custt, Flight fi) {
    ...
    public ReservationDB(int n_s, ArrayList<String> s_n, double c, Customer custt, Flight fi, int r) {
