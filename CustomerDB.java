 ...
 * Customer Class
 * 
 * Creates a Customer class to detail what makes up a Customer: Unique Customer ID Number Customer's
 * first name. Customer's last name. Customer's email.
 *
...
public class CustomerDB {
    ...
    public CustomerDB(String fName, String lName, String e) {
